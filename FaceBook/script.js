...
var elbtnUser = document.getElementById('btnUser');
function loginuser(){
    ...
    function signIn(username, password) {
        ...
        if (isUserValid(username, password)) {
            ...
            document.write(`<h1>ME Facebook</h1>`);
            document.write(`<button>Logout user</button>`);
...
elbtnUser.addEventListener("click", loginuser, false);
